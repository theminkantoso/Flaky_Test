...
if __name__ == "__main__":
    ...
    for (trnIdx, tstIdx) in kf.split(dataPoints, dataLabelsList):
        ...
        model.fit(X_train, Y_train, batch_size=128, epochs=6,class_weight=class_weight)
