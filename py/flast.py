...
def flastVectorization(dataPoints, dim=0, eps=0.3):
    ...
    temp = ['Hello I am a professional']
    temp2 = ['I am Hello professional a']
    Z_temp = countVec.fit_transform(temp)
    Z_temp2 = countVec.fit_transform(temp2)
    print("Debug")
    print(Z_temp.toarray())
    # print(Z_temp.get_feature_names_out())
    print("2nd one")
    # print(Z_temp2.get_feature_names_out())
    print(Z_temp2.toarray())
    if eps == 0:
        Z = Z_full
    else:
        if dim <= 0:
